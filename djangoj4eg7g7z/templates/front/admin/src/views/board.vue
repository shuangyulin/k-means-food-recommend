		...
		<div :style='{"padding":"0 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"15px","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="meishiinfoChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="meishiinfoChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="meishiinfoChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0 0 20px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"100px"}'>
					...
					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250107/1f7eba19214f45b0927b3bd789f47556.png) no-repeat center / 100% 100%","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","justifyContent":"space-evenly","height":"78px","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexWrap":"wrap","flexDirection":"row","flex":"auto","display":"flex","width":"0","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","textOverflow":"ellipsis","height":"24px"}'>美食信息总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(52, 171, 255)","fontWeight":"bold","order":"20"}'>{{meishiinfoCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts6">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="meishiinfoChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts7">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<el-table id="meishiinfoTable" :data="meishiinfoList" border :stripe="true" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"0","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="shopname" label="店名">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="msname" label="美食名称">
						</el-table-column>
						...
						<el-table-column :resizable="true" :sortable="false" prop="monthsales" label="月销量">
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexDirection":"row","display":"flex","transition":"0.3s","justifyContent":"flex-start","flexWrap":"wrap","background":"none","flex":"0 0 auto","gap":"8px","width":"40%","height":"calc(40% - 50px)","order":"20"}'>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(100% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							店名
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.shopname" placeholder="请输入店名"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(100% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							评分
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.score" placeholder="请输入评分"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(100% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							月销量
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.monthsales" placeholder="请输入月销量"></input>
					</div>
					<div :style='{"border":"1px solid rgb(52, 171, 255)","padding":"0 10px","margin":"0","alignItems":"center","borderRadius":"5px","display":"flex","width":"calc(100% - 4px)","justifyContent":"space-between","order":"1"}'>
						<div :style='{"width":"auto","fontSize":"12px","color":"#999","textAlign":"left"}'>
							价格
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","outline":"none","color":"#fff","background":"transparent","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.jiage" placeholder="请输入价格"></input>
					</div>
					<div :style='{"padding":"0 0 0 30px","margin":"0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","fontSize":"16px","height":"auto"}'>
						预测美食名称：{{form.msname}}
					</div>
					<div @click="forecastClick" :style='{"border":"1px solid rgb(255, 156, 12)","cursor":"pointer","margin":"0","color":"rgb(255, 156, 12)","borderRadius":"5px","textAlign":"center","background":"none","width":"calc(33.33% - 8px)","lineHeight":"34px","height":"34px","order":"2"}'>
						立即预测
					</div>
				</div>
			</div>
			<div :style='{"padding":"15px","flexWrap":"wrap","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="meishiinfoChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="meishiinfoChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		...
		created() {
			this.$nextTick(()=>{
				this.times()
				setTimeout(()=>{
					this.getmeishiinfoCount();
					this.meishiinfoChat1();
					this.meishiinfoChat2();
					this.meishiinfoChat3();
					this.meishiinfoChat4();
					this.meishiinfoChat5();
					this.meishiinfoChat6();
				},500)
			})
		},
		methods:{
				...
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								url: 'meishiinfoforecast/forecast',
								method: 'post',
								data: this.forecastForm
							}).then(obj=>{
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'meishiinfoforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			getmeishiinfoList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.meishiinfoList = data.data.list;
						let div = document.getElementById('meishiinfoTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.meishiinfoTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.meishiinfoTimer);
						})
			...
			getmeishiinfoCount() {
				this.$http({
					url: `meishiinfo/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.meishiinfoCount = data.data
					}
				})
			},
			//统计接口1
			meishiinfoChat1() {
				this.$nextTick(()=>{
					...
					var meishiinfoChart1 = echarts.init(document.getElementById("meishiinfoChart1"),'macarons');
					this.$http({
						url: "meishiinfo/group/shopname",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							meishiinfoChart1.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								meishiinfoChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
				...
				this.$nextTick(()=>{
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							var option = {};
							this.wordclouds(pArray,'meishiinfoChart2');
			...
			meishiinfoChat3() {
				this.$nextTick(()=>{
					...
					var meishiinfoChart3 = echarts.init(document.getElementById("meishiinfoChart3"),'macarons');
					this.$http({
						url: `meishiinfo/value/msname/score`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							meishiinfoChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								meishiinfoChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			meishiinfoChat4() {
				this.$nextTick(()=>{
					...
					var meishiinfoChart4 = echarts.init(document.getElementById("meishiinfoChart4"),'macarons');
					this.$http({
						url: `meishiinfo/value/shopname/qsprice`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							meishiinfoChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								meishiinfoChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			meishiinfoChat5() {
				this.$nextTick(()=>{
					...
					var meishiinfoChart5 = echarts.init(document.getElementById("meishiinfoChart5"),'macarons');
					this.$http({
						url: `meishiinfo/value/shopname/monthsales`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							meishiinfoChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								meishiinfoChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			meishiinfoChat6() {
				this.$nextTick(()=>{
					...
					var meishiinfoChart6 = echarts.init(document.getElementById("meishiinfoChart6"),'macarons');
					this.$http({
						url: `meishiinfo/value/msname/jiage`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							meishiinfoChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								meishiinfoChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
