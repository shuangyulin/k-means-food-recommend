...
class xuesheng(BaseModel):
    ...
    xueshengzhanghao=models.CharField ( max_length=255,null=False,unique=True, verbose_name='学生账号' )
...
class meishiinfo(BaseModel):
    __doc__ = u'''meishiinfo'''
    __tablename__ = 'meishiinfo'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    shopname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='店名' )
    msname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='美食名称' )
    ...
    qsprice=models.FloatField   (  null=True, unique=False, verbose_name='起送' )
    psprice=models.FloatField   (  null=True, unique=False, verbose_name='配送' )
    monthsales=models.IntegerField  (  null=True, unique=False, verbose_name='月销量' )
    jiage=models.FloatField   (  null=True, unique=False, verbose_name='价格' )
    stock=models.IntegerField  (  null=True, unique=False, verbose_name='库存' )
    shopurl=models.TextField   (  null=True, unique=False, verbose_name='商店地址' )
...
class meishiinfoforecast(BaseModel):
    __doc__ = u'''meishiinfoforecast'''
    __tablename__ = 'meishiinfoforecast'
...
class discussmeishiinfo(BaseModel):
    __doc__ = u'''discussmeishiinfo'''
    __tablename__ = 'discussmeishiinfo'
    ...
    '''
    class Meta:
        db_table = 'discussmeishiinfo'
        verbose_name = verbose_name_plural = 'meishiinfo评论表'
