...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderfg054mx8 && scrapy crawl "+tableName+"Spider -a databaseName=djangoj4eg7g7z"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangoj4eg7g7z"
        os.system(cmd)
